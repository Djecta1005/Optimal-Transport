...
#########################################
## Here we will test the RIOT approach on a random dataset ##
#########################################
...
# Initialise relaxation parameters
...
colors=['deeppink', 'deepskyblue', 'yellow']
linestyles = [':', '-.', '--']
fig, ax = plt.subplots()
...
plt.savefig("noisesEffect.png",dpi=1500)
plt.show()
